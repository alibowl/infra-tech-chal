...
### Update helm chart values & deploy
- deploy app via helm `helm install pokemon-app`
- troubleshoot issues
  - `k get pods`
  - `k describe pod pokemon-app-[id]`
...
- deployed via helm and can browse locally to app `http://127.0.0.1:8000/`

## Build image,test and push to repository

### Fork the repo so I can create Github Actions
note - at this point as this was my local machine I noticed vs code autosave was not on and I lost a few things, auto-save now on so plough forward again.
- repo forked
